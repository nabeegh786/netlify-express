...
exports.approveOrRejectBooking = asyncHandler(async (req,res) => {
    ...
    Booking.findByIdAndUpdate(
        ...
        if(success){
            ...
            return res.status(500).json({Success:true,Message:`Something Went Wrong Cannot  ${Message} Request `+err, responseCode : 500});
        }
});
